# CORNICE DINAMICA — PAROLE CHIAVE INTERATTIVE (embed per Blogger)

Questa cartella contiene la **cornice dinamica** dell'app PAROLE CHIAVE INTERATTIVE: un blocco
...
| Dedicata a Parole Chiave Interattive | ✅ sì (URL fisso) | riutilizzabile (`?app=`) | riutilizzabile |
...
1. **URL dell'app (file esistenti)**: nei file HTML cerca `https://shakespeare-quiz-2.easy-peasy.site`
...
- Il titolo "PAROLE CHIAVE INTERATTIVE" è in **OpenDyslexic Bold** (17px, letter-spacing 2px, colore plum),
